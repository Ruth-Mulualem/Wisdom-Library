...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2022 at 05:12 PM
...
(1, '1', 'fikir eskemekabr', 'amharics', 'fictions', 5, 1991, 'daniel amdemichaels', 104, 'A'),
...
INSERT INTO `user` (`id`, `first name`, `middle name`, `last name`, `email`, `password`, `DOB`, `age`, `sex`, `vkey`, `verified`, `createDate`, `image_url`) VALUES
...
--
ALTER TABLE `donated books`
  MODIFY `DonationId` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
