			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of Events</b>
						<span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="Dashboard for user.php?page=manage_event" id="new_event">
					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
                            ...
                            <?php 
								$i = 1;
								$events = $con->query("SELECT e.*,v.venue FROM events e inner join venue v on v.id=e.venueID order by e.id asc");
								...
								<tr>
									...
									<td class="">
										 <p> <b><?php echo date("M d, Y h:i A",strtotime($row['time'])) ?></b></p>
									</td>
									<td class="">
										 <p> <b><?php echo ucwords($row['venue']) ?></b></p>
									</td>
									<td class="">
										 <p>Event: <b><?php echo ucwords($row['eventName']) ?></b></p>
