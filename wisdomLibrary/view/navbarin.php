            ...
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul class="collapse">
                            <li><a href="bookAdd.php">Add Books</a></li>
                            <li><a href="issueBook.php">Issued Books</a></li>
                            <li><a href="Book Update.php">Update</a></li>
                            <li><a href="Book donation.php">Book Donation</a></li>
                        </ul>
                    </li>
